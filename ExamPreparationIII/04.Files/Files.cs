    ...
    class Files
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                string[] fileData = input.Last().Split(new char[] { ';' }, StringSplitOptions.RemoveEmptyEntries).ToArray();
                string root = input[0];
            ...
            var sorted = storage.Where(a => a.Key == dir).OrderByDescending(b => b.Value.Values);
